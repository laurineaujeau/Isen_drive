...
//const uri = "mongodb+srv://laurineaujeau:fri2Fqazdp8aiO3D@clusterlau.3ygvuly.mongodb.net/?retryWrites=true&w=majority";
const uri = process.env.MONGODB_URI;
const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true, serverApi: ServerApiVersion.v1 });
// client.connect(err => {
//     const categoriesCollection = client.db("isen_drive").collection("categories");
//     const productsCollection = client.db("isen_drive").collection("products");
